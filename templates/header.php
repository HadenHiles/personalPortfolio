...
<div class="navbar navbar-inverse" id="navbar" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" onclick="$('html, body').animate({scrollTop: $('body').offset().top}, 1000);"><img src="../images/logo/stamp-light-bevel.png" class="img-responsive large_logo" /><img src="../images/logo/stamp-small-bevel-light.png" class="img-responsive small_logo" /></a>
            </div>
